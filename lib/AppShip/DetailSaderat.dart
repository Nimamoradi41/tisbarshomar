...
class DetailSaderat extends StatefulWidget {

  DataModelAnbarService data;

  DetailSaderat(this.data);

  @override
  State<DetailSaderat> createState() => _SaderatDetalState();

}

class _SaderatDetalState extends State<DetailSaderat> {
  ...
  var txt=TextEditingController();
    ...
    Future  Run_Add_Tasc(ProgressDialog progressDialog,String truckId) async{
      ...
      // data_truck.exit=ss_2;
      print('Data Is'+truckId);
      _showMyDialog(progressDialog,ss_1);



    }

 Future   Run_Act(ProgressDialog progressDialog,String enterDate,String id) async
    {
       bool test=  await ApiService.Add_Tasck_Saderat(progressDialog, enterDate,context,id) ;
       ...
       if(test)
         ...
         print(data.toString());
         var rr=  data.where((element) =>element.truckNumberId.toString().contains(widget.data.truckTruckNumberId)).toList();
         if(rr.length>0)
         {
           print(rr[0].ToMapDatabase().toString());
           data_truck=rr[0];
           print('Hidata'+enterDate);
           widget.data.enterFunnel=enterDate;
           widget.data.Id_Car=data_truck.id;
           Navigator.pop(context,widget.data);
         }

         // var dad= await DataBseFile.db.newService(data_truck);
       }
    }
  ...
  Future<void> _showMyDialog(ProgressDialog progressDialog,String enterDate) async {
          ...
          actions: <Widget>[
            TextButton(
              ...
              onPressed: () {
                ...
                print('Hidata'+enterDate);
                Run_Act(progressDialog,enterDate,widget.data.id);
              },
            ),
            TextButton(
      ...
      body: Container(
        ...
        child:Column(
          children: [
            ...
            Flag_Page=='3'?
            SendAll(shipName: shipName, completedServices: completedServices,):Container(),
                                ...
                                child: Column(
                                  children: [
                                    Expanded(
                                      flex: 7,
                                      child: Center(
                                        child: Text(  widget.data.truckTruckNumberId.isEmpty?
                                         ' نامشخص ':
                                        widget.data.truckTruckNumberId,
                                          textAlign: TextAlign.center,
                                          style: TextStyle(
                                            color: Colors.white,
                                            fontWeight: FontWeight.bold,
                              ...
                              child: Column(
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: Padding(
                                      padding: const EdgeInsets.only(top: 16.0,right: 16.0),
                                      child: Text(  widget.data.truckTruckName.isEmpty?
                                      ' نامشخص ':
                                      widget.data.truckTruckName,
                                        textAlign: TextAlign.end,
                                        style: TextStyle(
                                          color:  BaseColor,
                                          fontWeight: FontWeight.bold,
                                  ...
                                  Container(
                                    ...
                                    child: Padding(
                                      padding: const EdgeInsets.only(top: 16.0,right: 16.0),
                                      child: Text(  widget.data.exitWarehouse.isEmpty?
                                      '  زمان ایجاد سرویس :'+ ' نامشخص ':
                                      '  زمان ایجاد سرویس :'+ widget.data.exitWarehouse
                                        ,
                                        textAlign: TextAlign.end,
                                        style: TextStyle(
                                          color: Colors.white,
                                  ...
                                  Container(
                                    ...
                                    child: Padding(
                                      padding: const EdgeInsets.only(top: 16.0,right: 16.0),
                                      child: Text(
                                        widget.data.carPlates.isEmpty?
                                        '  شماره پلاک :'+ ' نامشخص ':
                                        '  شماره پلاک :'+ widget.data.carPlates
