...
class NewWidget extends StatelessWidget {
  ...
  NewWidget(this.S1, this.S2, this.S3, this.S4);
                ...
                Expanded(
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Expanded(
                            child: Text(S2.isEmpty?'نامشخص':S2,
                ...
                Expanded(
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Expanded(
                            child: Text(S1.isEmpty?'نامشخص':S1,
                              textAlign: TextAlign.center,
                              style: TextStyle(
                                  color: Colors.white,
                                  fontSize: 14
                ...
                Expanded(
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Expanded(
                            child: Text(S4.isEmpty?'نامشخص':S4,
                              textAlign: TextAlign.center,
                              style: TextStyle(
                                  color: Colors.white,
                                  fontSize: 14
                ...
                Expanded(
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Expanded(
                            child: Text(S3.isEmpty?'نامشخص':S3,
                              textAlign: TextAlign.center,
                              style: TextStyle(
                                  color: Colors.white,
                                  fontSize: 14
...
class _MainPageState extends State<MainPage> {
 ...
 Future   Run_Act(ProgressDialog progressDialog,String truckId,String enterDate,String exitDate) async
    {
       bool test=  await ApiService.Add_Tasck(progressDialog,truckId, enterDate, exitDate,data_truck,context) ;
                      ...
                      children: [
                        ...
                        Expanded(child: GestureDetector(
                          ...
                          Icon(Icons.send,
                              size: 40,
                              color:
                              Flag_Page=='3'?Colors.white:Color(0xff74808C)),)),
                        Expanded(child: GestureDetector(
                          onTap: (){
                            if(Flag_Page!='2')
                            {
